...
//         body: JSON.stringify({ name, password }) // Mudando para enviar o nome
//       });
...
//         localStorage.setItem('created_by', user.id);
...
//             />
//             {/* <button className="show-hide" onClick={() => setShowPassword(!showPassword)}>
